...
<template>
    <header class="flex h-[5rem] items-center w-full border-b border-catskwhite justify-between mt-[1.75rem] pb-6">
        ...
        <div class="bg-[#fff] absolute w-[22.5rem] h-[16rem] grid grid-rows-[25%_75%] inset-0 left-[57%] top-[9%] rounded-[0.625rem] shadow-lg bg-[rgba(29, 32, 38, 0.50)]" :class="clicked ? 'block' : 'hidden'" >
